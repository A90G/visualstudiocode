...
let cliente1:Cliente=new Cliente('Juan','Perez',11111,'Velez Sarfield',autores,generos,1);
let cliente2:Cliente=new Cliente('Hernan','Rodriguez',112212,'Nuñez',autores,generos,1);
